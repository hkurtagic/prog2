...
public class WatchlistMovieCell extends ListCell<Movie> {
    ...
    private final JFXButton removeFromWatchlistBtn = new JFXButton("Remove to watchlist");
    private final VBox layout = new VBox(title, detail, genre, removeFromWatchlistBtn, detailBtn);
    private boolean collapsedDetails = true;
    public List<Movie> observableMovies = FXCollections.observableArrayList();;
    public WatchlistMovieCell() {
        super();
        // color scheme
        ...
        removeFromWatchlistBtn.setOnMouseClicked(mouseEvent -> {
                try {
                    ...
                    List<MovieEntity> me = movieRepository.get(getItem().getTitle());

                    watchlistRepository.delete(WatchlistMovieEntity.toWatchlistMovieEntry(me.get(0)));
